...
public class FragmentNoteBindingImpl extends FragmentNoteBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.nameTextView, 3);
        sViewsWithIds.put(R.id.btn_logout, 4);
        sViewsWithIds.put(R.id.rv_home, 5);
        sViewsWithIds.put(R.id.fab_add, 6);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.isEmpty == variableId) {
            ...
            setViewModel((com.fajar.notetakingapp.ui.home.NoteViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.fajar.notetakingapp.ui.home.NoteViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            com.fajar.notetakingapp.ui.home.adapter.BindingAdapterKt.hideIfEmpty(this.tvEmpty, androidxDatabindingViewDataBindingSafeUnboxIsEmpty);
        }
    }
