...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvNothave;

  private FragmentRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRegister,
      @NonNull TextInputLayout edtConfirmPassword, @NonNull TextInputLayout edtEmail,
      @NonNull TextInputLayout edtPassword, @NonNull TextInputLayout edtUsername,
      ...
      @NonNull ImageView imgLogin, @NonNull TextView tvLogin, @NonNull TextView tvNothave) {
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextInputLayout edtConfirmPassword = ViewBindings.findChildViewById(rootView, id);
      if (edtConfirmPassword == null) {
        break missingId;
      }

      id = R.id.edt_email;
      TextInputLayout edtEmail = ViewBindings.findChildViewById(rootView, id);
      if (edtEmail == null) {
        break missingId;
      }

      id = R.id.edt_password;
      TextInputLayout edtPassword = ViewBindings.findChildViewById(rootView, id);
      if (edtPassword == null) {
        break missingId;
      }

      id = R.id.edt_username;
      TextInputLayout edtUsername = ViewBindings.findChildViewById(rootView, id);
      if (edtUsername == null) {
        break missingId;
      }
      ...
      id = R.id.tv_nothave;
      TextView tvNothave = ViewBindings.findChildViewById(rootView, id);
      if (tvNothave == null) {
        break missingId;
      }

      return new FragmentRegisterBinding((ConstraintLayout) rootView, btnRegister,
          edtConfirmPassword, edtEmail, edtPassword, edtUsername, etConfirmPassword, etEmail,
          etPassword, etUsername, imgLogin, tvLogin, tvNothave);
    }
