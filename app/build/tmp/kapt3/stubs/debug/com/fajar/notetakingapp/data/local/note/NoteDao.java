...
public abstract interface NoteDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM notes WHERE noteId = :id")
